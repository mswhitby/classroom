...
### 1. Self Paced Introduction to Turtle Programming In App Lab - Lesson 6
...
- To access the assignment, **you must log into Code.org using your Clever account**. Please do the following:
    ...
    - Complete **Self Paced Introduction to Turtle Programming In App Lab Assign - Lesson 6**.

- **If you're already logged in** and cannot find the assignment, you can use this [link](https://studio.code.org/s/csp3-virtual/lessons/6/levels/1).
