...
### 1. Self Paced Introduction to Turtle Programming In App Lab - Lesson 5
...
- To access the assignment, **you must log into Code.org using your Clever account**. Please do the following:
    ...
    - Complete **Self Paced Introduction to Turtle Programming In App Lab Assign - Lesson 5**.

- **If you're already logged in** and cannot find the assignment, you can use this [link](https://studio.code.org/s/csp3-virtual/lessons/5/levels/1).

### 2. Journal

- Complete your journal entry for this week if you have not completed it yet.
- The journal entry was [April 28, 2025](https://github.com/mswhitby/WHSTechNotes/blob/main/journal.md#april-28-2025).
...
https://studio.code.org/s/gen-ai-humanities
https://studio.code.org/s/gen-ai-humanities
...
### 1. Coding Interactive Maps - Lessons 1 - 4
...
### 1. Coding Interactive Maps - Lessons 3 & 4: Mapmaking Introduction

- To access the assignment, **you must log into Code.org using your Clever account**. Please do the following:
    - Visit this [link](https://clever.com/oauth/district-picker?client_id=2f27405716644a951b23&redirect_uri=https%3A%2F%2Fstudio.code.org%2Fusers%2Fauth%2Fclever%2Fcallback&response_type=code&state=ede33ff61289cf32708a0f54079cdd23e31d0b0a02b0e0e8).
    - Search for **Karen Wagner**.
    - Log in with Google using your school email address.
    - Complete **Lesson 3 & 4: Mapmaking Introduction**.
...
### 1. Coding Interactive Maps - Lesson 2: Mapmaking Introduction

- To access the assignment, **you must log into Code.org using your Clever account**. Please do the following:
    - Visit this [link](https://clever.com/oauth/district-picker?client_id=2f27405716644a951b23&redirect_uri=https%3A%2F%2Fstudio.code.org%2Fusers%2Fauth%2Fclever%2Fcallback&response_type=code&state=ede33ff61289cf32708a0f54079cdd23e31d0b0a02b0e0e8).
    - Search for **Karen Wagner**.
    - Log in with Google using your school email address.
    - Complete **Lesson 2: Mapmaking Introduction**.
...
### 2. Code with Anna and Elsa

- Complete the **Code with Anna and Elsa** coding assignment that we started yesterday.
...
- [Star Wars: Building a Galaxy With Code](https://github.com/mswhitby/classroom/blob/main/_docs/classes/3rd.md#january-30-2025)
- [Flappy Code](https://github.com/mswhitby/classroom/blob/main/_docs/classes/3rd.md#january-29-2025)
- [Hello World: Transformers One](https://github.com/mswhitby/classroom/blob/main/_docs/classes/3rd.md#january-28-2025)
- [Disney Infinity Play Lab](https://github.com/mswhitby/classroom/blob/main/_docs/classes/3rd.md#january-23-2025)
- [Moneyball Questions](https://github.com/mswhitby/classroom/blob/main/_docs/classes/3rd.md#january-15-2025)
- [Code your own sports game](https://github.com/mswhitby/classroom/blob/main/_docs/classes/3rd.md#january-10-2025)
- [Minecraft: Voyage Aquatic](https://github.com/mswhitby/classroom/blob/main/_docs/classes/3rd.md#january-9-2025)
...
- We'll finish reviewing yesterday's journal as a class.

### 2. Hello World: Transformers One
