...
### 1. Self Paced Introduction to Turtle Programming In App Lab - Lesson 2
...
- To access the assignment, **you must log into Code.org using your Clever account**. Please do the following:
    ...
    - Search for **Karen Wagner**.
    - Log in with Google using your school email address.
    - Complete **Self Paced Introduction to Turtle Programming In App Lab Assign - Lesson 2**.
...
- Complete your journal entry for this week if you have not completed it yet.
- The journal entry was [April 14, 2025](https://github.com/mswhitby/classroom/blob/main/_docs/classes/1st.md#april-14-2025).
- You must email me to let me know you've submitted your journal late. If you do not email me, your journal entry may not be graded.
...
### 2. Make-Up Test
- If you were not here on March 20, 2025, please come speak to me about completing your make-up test. **All tests must be completed before this Friday**.
...
### 1. Coding Interactive Maps - Lessons 2 & 3: Mapmaking Introduction
...
- Complete the **Code with Anna and Elsa** coding assignment.
...
- Complete **Minecraft: Voyage Aquatic** if you did not finish yesterday. 
- To access the assignment, you must log into Code.org using your Clever account. Please do the following:
    - Visit this [link](https://clever.com/oauth/district-picker?client_id=2f27405716644a951b23&redirect_uri=https%3A%2F%2Fstudio.code.org%2Fusers%2Fauth%2Fclever%2Fcallback&response_type=code&state=ede33ff61289cf32708a0f54079cdd23e31d0b0a02b0e0e8).
    - Search for **Karen Wagner**.
    - Log in with Google using your school email address.
...
- Here is the information for your Semester Exam: [December 17, 2024](https://github.com/mswhitby/classroom/blob/main/_docs/classes/1st.md#december-17-2024)
- Here is the information for your completing missing work: [December 13, 2024](https://github.com/mswhitby/classroom/blob/main/_docs/classes/1st.md#december-13-2024)
...
- **Discovery Education**
    - [Calculations with Variables](https://classlink.discoveryeducation.com/learn/player/8d57f853-c9f1-4678-ab23-517bbc6693fc) - Assigned on November 6, 2024
     - [Inputs and Variables](https://classlink.discoveryeducation.com/learn/player/3db4dc12-e275-470d-bb2e-efec6773aea1) - Assigned on November 18, 2024
...
- If you're already logged in and cannot find the assignment, you can use this [link](https://studio.code.org/s/mc?section_id=5693468).
...
- Go to the **"Lessons"** tab and complete the following lessons:
    1. Text 1: Hello World! (If you haven't finished yet)
